...
#define EXISTED_FRIEND "friend exited"
...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_ALL_ONLINE_REQUEST,//用户在线请求
    ENUM_MSG_TYPE_ALL_ONLINE_RESPOND,//用户在线回复

    ENUM_MSG_TYPE_SEARCH_USR_REQUEST,//搜索用户在线请求
    ENUM_MSG_TYPE_SEARCH_USR_RESPOND,//搜索用户在线回复
    ...
    ENUM_MSG_TYPE_MAX = 0x00ffffff//32
};
...
PDU *mkPDU(uint uiMsgLen);//产生变化的结构体
