...
Friend::Friend(QWidget *parent) : QWidget(parent)
{
    ...
    m_pShowOnlineUsrPB = new QPushButton("显示好友在线状态");
    m_pSearchUsrPB = new QPushButton("查找好友用户");
    ...
    pMsgHBL->addWidget(m_pInputMsgLE);
     ...
     connect(m_pShowOnlineUsrPB,SIGNAL(clicked(bool)),this,SLOT(showOnline()));//关联信号槽
...
void Friend::flushFriend()
{
  ...
  TcpClient::getInstance().getTcpSocket().write((char*)pdu,pdu->uiPDULen);//获取socket
  free(pdu);
  pdu = NULL;
}
